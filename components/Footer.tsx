...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--color-brand-blue-dark)] text-white py-12 md:py-16" id="contact">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:border-[var(--color-brand-teal)] bg-white transition-colors"
                >
              ...
              <button
                ...
                className={`w-full font-bold py-4 rounded-lg transition-all duration-300 mt-4 flex items-center justify-center gap-2 ${
                  sent
                    ...
                    : "bg-[var(--color-brand-gold)] hover:bg-[var(--color-brand-gold-light)] text-[var(--color-brand-blue-dark)] hover:scale-[1.02] shadow-lg"
                }`}
              >
                {sent ? (
                  <>
